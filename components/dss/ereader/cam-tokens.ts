...
// Pale e-ink wash behind each badge (dashboard.css --state-*-bg).
export const stateBgVar: Record<StateKey, string> = {
  running: "var(--state-running-bg)",
  waiting: "var(--state-waiting-bg)",
  recovering: "var(--state-recovering-bg)",
  blocked: "var(--state-blocked-bg)",
  failed: "var(--state-failed-bg)",
  completed: "var(--state-completed-bg)",
  unknown: "var(--state-unknown-bg)",
}

// Hatch tone for the badge field (dashboard.css --state-*-hatch), so a
// status is textured like the wordmark instead of flat-filled.
export const stateHatchVar: Record<StateKey, string> = {
  running: "var(--state-running-hatch)",
  waiting: "var(--state-waiting-hatch)",
  recovering: "var(--state-recovering-hatch)",
  blocked: "var(--state-blocked-hatch)",
  failed: "var(--state-failed-hatch)",
  completed: "var(--state-completed-hatch)",
  unknown: "var(--state-unknown-hatch)",
}
