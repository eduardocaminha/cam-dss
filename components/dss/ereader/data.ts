...
export const implementers: (PipelineStage & { n: number; story: string })[] = [
  ...
  { key: "implementer", label: "Implementer 2", n: 2, story: "US-009", state: "active", model: "sonnet", effort: "medium", tokens: "41k", cost: "$0.49", time: "18m", note: "editing commands-card.tsx", activity: ["editing components/dss/ereader/session-card.tsx", "wiring the FlowBar component", "running pnpm typecheck", "verifying in browser preview"] },
